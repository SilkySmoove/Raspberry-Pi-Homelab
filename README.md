...
### Problems I hit (and how I solved them)
- **Router login didn't work at first** - Hitron CODA modems (used by Fizz/Cogeco/Rogers) are largely locked down by the ISP; expected the DNS field to be read-only. It wasn't — found it under Basic → DNS instead of Advanced.
